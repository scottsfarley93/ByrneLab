...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  * {
  ...
  <body>
	<?php
		echo "<i>Testing database access...</i>";
		$connection = mysqli_connect('localhost', 'calpalynUser', 'BerkeleyPaleoecology', 'calpalyn');
		if (!$connection){
			die("Connection Error: " . mysqli_connect_error());
		}else{
			echo "Connection to MySQL database platform successful.";
		}
	?>
    <div class="main_page">
      <div class="page_header floating_element">
        ...
        <span class="floating_element">
          Calpalyn Server in Byrne Lab up and running. 
        </span>
      </div>
...
-->
      <div class="content_section floating_element">
        ...
        <div class="section_header section_header_red">
          <div id="about"></div>
          Hi! I wrote this on ip: 128.32.101.83...
        </div>
