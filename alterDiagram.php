  ...
  <body>
    ...
    <div class="container" id='mainPage'>
    	...
    	<ul id='settings' class='list-group'>
    		...
    		<li class='list-group-item'>Calpalyn Listing<input class='right checkbox-inline' type='checkbox' id='doListingBox'/>
...
<div class='modal-dialog'>
	...
	$.ajax({
		...
		success: function(response){
			...
			if (config['doListing'] == true || config['doListing'] == "true"){
				$("#doListingBox").attr('checked', 'true')
			}
			config=response;
		},
		error: function(e){
...
$("#saveButton").click(function(){
	...
	var doListing = $("#doListingBox").prop('checked');
	var now = new Date();
